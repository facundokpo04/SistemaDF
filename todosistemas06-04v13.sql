...
INSERT IGNORE INTO `pedidoencabezado` (`pe_id`, `pe_idCliente`, `pe_idEmpleado`, `pe_aclaraciones`, `pe_comentarios`, `pe_idEstado`, `pe_Total`, `pe_idPersona`, `pe_cli_tel`, `pe_idDireccion`, `pe_medioPago`, `pe_fechaPedido`, `pe_motivoCancelado`) VALUES
	(13, '8', NULL, 'sin cebolla', ' Producto = Muzzarella comentario =undefined\n Producto = Napolitana comentario =undefined\n', 1, 120, 8, '3758483058', 3, 'Tarjeta Debito', '2017-04-17 17:39:56', NULL),
	(14, '8', NULL, 'sin cebolla', ' Producto = Muzzarella comentario =undefined\n', 1, 150, 8, '3758483058', 3, 'Tarjeta Debito', '2017-04-17 17:39:56', NULL),
...
-- Volcando datos para la tabla deliverydb.persona: ~3 rows (aproximadamente)
...
INSERT IGNORE INTO `producto` (`prod_id`, `prod_idCategoria`, `prod_nombre`, `prod_codigoProducto`, `prod_descripcionProducto`, `prod_precioBase`, `prod_maxComponente`, `prod_minComponente`, `prod_idEstado`, `prod_idEstadoVisible`, `prod_idSucursal`, `prod_imagen`) VALUES
	(1, 3, 'Napolitana', '01256', 'Muzzarela, salsa ajo y rodajas de tomate', 120, 0, 0, 1, 1, 4, 'promos1.PNG'),
...
-- Volcando datos para la tabla deliverydb.productopromo: ~6 rows (aproximadamente)
...
-- Volcando datos para la tabla deliverydb.promo: ~4 rows (aproximadamente)
...
INSERT IGNORE INTO `promo` (`pro_id`, `pro_nombre`, `pro_descripcion`, `pro_precio`, `pro_descuento`, `pro_FechaInicio`, `pro_FechaFin`, `pro_imagen`, `pro_idEstado`) VALUES
	(1, 'Promo 1', 'Algo', 150, 20, '1970-01-01', '1970-01-01', 'promo1.jpg', 1),
...
-- Volcando datos para la tabla deliverydb.tablasrelacion: ~1 rows (aproximadamente)
