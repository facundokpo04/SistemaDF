...
-- Dumping data for table deliverydb.categoria: ~5 rows (approximately)
...
-- Dumping data for table deliverydb.datocontacto: ~1 rows (approximately)
...
INSERT IGNORE INTO `datocontacto` (`dcon_id`, `dcon_facebook`, `dcon_website`, `dcon_twitter`, `dcon_direccion`, `dcon_idSucursal`, `dcon_email`) VALUES
	(3, 'facebook.com/pizzacolordelivery', 'www.pizzacolordelivery.com', '', 'Cordoba 255 ', 4, 'delivey@gmail.com');
...
-- Dumping data for table deliverydb.detallepedido: ~2 rows (approximately)
...
-- Dumping data for table deliverydb.diahorario: ~10 rows (approximately)
...
-- Dumping data for table deliverydb.empleado: ~1 rows (approximately)
...
-- Dumping data for table deliverydb.parametros: ~1 rows (approximately)
...
-- Dumping data for table deliverydb.pedidoencabezado: ~2 rows (approximately)
...
-- Dumping data for table deliverydb.persona: ~2 rows (approximately)
...
-- Dumping data for table deliverydb.producto: ~10 rows (approximately)
...
-- Dumping data for table deliverydb.productopedido: ~3 rows (approximately)
...
-- Dumping data for table deliverydb.productopromo: ~2 rows (approximately)
...
-- Dumping data for table deliverydb.promo: ~3 rows (approximately)
...
-- Dumping data for table deliverydb.promopedido: ~1 rows (approximately)
...
-- Dumping data for table deliverydb.tablasrelacion: ~1 rows (approximately)
...
-- Dumping data for table deliverydb.telefonocontacto: ~2 rows (approximately)
...
-- Dumping data for table deliverydb.variedad: ~12 rows (approximately)
