...
-- Dumping data for table deliverydb.componenteppedido: ~2 rows (approximately)
DELETE FROM `componenteppedido`;
/*!40000 ALTER TABLE `componenteppedido` DISABLE KEYS */;
INSERT INTO `componenteppedido` (`cpp_id`, `cpp_idProductoPedido`, `cpp_idComponente`) VALUES
	(1, 6, 4),
	(2, 6, 6),
	(3, 7, 4);
...
INSERT INTO `detallepedido` (`dp_id`, `dp_Cantidad`, `dp_PrecioUnitario`, `dp_Total`, `dp_idProductoPedido`, `dp_idPedidoEncabezado`) VALUES
	(3, 1, 50, NULL, 5, 13),
	(4, 1, 216, NULL, 7, 14);
...
INSERT INTO `empleado` (`emp_id`, `emp_legajo`, `emp_idPersona`, `emp_imagen`, `emp_cargo`, `emp_idSucursal`) VALUES
...
-- Dumping data for table deliverydb.empresa: ~0 rows (approximately)
DELETE FROM `empresa`;
...
INSERT INTO `promo` (`pro_id`, `pro_nombre`, `pro_descripcion`, `pro_precio`, `pro_descuento`, `pro_FechaInicio`, `pro_FechaFin`, `pro_imagen`) VALUES
	(1, 'Promo1', '', 0, 0, '1970-01-01', '1970-01-01', 'promo1.jpg'),
...
INSERT INTO `tablasrelacion` (`idEstado`, `relacion`, `descripcion`, `orden`, `valor`) VALUES
