...
CREATE TABLE IF NOT EXISTS `datocontacto` (
  ...
  `dcon_direccion` datetime DEFAULT NULL,
...
-- Volcando datos para la tabla deliverydb.empleado: ~1 rows (aproximadamente)
...
-- Volcando datos para la tabla deliverydb.parametros: ~1 rows (aproximadamente)
...
CREATE TABLE IF NOT EXISTS `productopedido` (
  ...
  `pp_idPromoPedido` int(11) NOT NULL,
  ...
  KEY `fk_productopedido_promopedido1_idx` (`pp_idPromoPedido`),
  ...
  CONSTRAINT `fk_productopedido_promopedido1` FOREIGN KEY (`pp_idPromoPedido`) REFERENCES `promopedido` (`ppro_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8;

-- Volcando datos para la tabla deliverydb.productopedido: ~3 rows (aproximadamente)
/*!40000 ALTER TABLE `productopedido` DISABLE KEYS */;
INSERT IGNORE INTO `productopedido` (`pp_id`, `pp_precioBase`, `pp_idProducto`, `pp_idPromoPedido`, `pp_idVariedad`, `pp_precioCalc`, `pp_aclaracion`) VALUES
	(5, 120, 1, 0, 3, 255, NULL),
	(6, 98, 2, 0, 2, 216, NULL),
	(7, 98, 2, 0, 1, 216, NULL);
...
CREATE TABLE IF NOT EXISTS `telefonocontacto` (
  ...
  `tcon_tipo` varchar(45) DEFAULT NULL,
...
-- Volcando datos para la tabla deliverydb.telefonocontacto: ~0 rows (aproximadamente)
