...
-- Dumping data for table deliverydb.categoria: ~6 rows (approximately)
...
INSERT IGNORE INTO `categoria` (`cat_id`, `cat_nombre`, `cat_descripcion`, `cat_idEstado`, `cat_imagen`, `cat_idEstadoVisible`) VALUES
	(1, 'Hamburguesas', 'hamburguesas', 1, 'hamburgesas.png', NULL),
	(2, 'Empanadas', 'empanada', 1, 'empanadas.png', NULL),
	(3, 'Pizzas', 'pizzas', 2, 'pizzas.png', NULL),
	(5, 'Calzones', 'calzones', 1, 'calzones.png', NULL),
	(6, 'Ensaladas', 'Ensaladas', 1, NULL, NULL),
	(7, 'Promociones', 'Promociones Varias', 1, 'Combo_7.jpg', NULL);
...
-- Dumping data for table deliverydb.componente: ~18 rows (approximately)
...
-- Dumping data for table deliverydb.componenteppedido: ~3 rows (approximately)
...
-- Dumping data for table deliverydb.componenteproducto: ~17 rows (approximately)
...
-- Dumping structure for table deliverydb.datocontacto
...
-- Dumping data for table deliverydb.datocontacto: ~0 rows (approximately)
...
INSERT IGNORE INTO `datocontacto` (`dcon_id`, `dcon_facebook`, `dcon_website`, `dcon_twitter`, `dcon_direccion`, `dcon_idSucursal`, `dcon_email`) VALUES
	(3, 'facebook.com/pizzacolordelivery', 'www.pizzacolordelivery.com', 'Alguntwitee', 'Cordoba 255 ', 4, 'delivey@gmail.com');
...
-- Dumping data for table deliverydb.detallepedido: ~3 rows (approximately)
...
-- Dumping data for table deliverydb.diahorario: ~7 rows (approximately)
...
-- Dumping structure for table deliverydb.direccion
...
-- Dumping data for table deliverydb.direccion: ~2 rows (approximately)
...
-- Dumping data for table deliverydb.pedidoencabezado: ~3 rows (approximately)
...
INSERT IGNORE INTO `pedidoencabezado` (`pe_id`, `pe_idCliente`, `pe_idEmpleado`, `pe_aclaraciones`, `pe_comentarios`, `pe_idEstado`, `pe_Total`, `pe_idPersona`, `pe_cli_tel`, `pe_idDireccion`, `pe_medioPago`, `pe_fechaPedido`, `pe_motivoCancelado`) VALUES
	...
	(15, '8', NULL, 'sin cebolla', ' Producto = Muzzarella con jamon comentario =undefined\n', 4, 150, 8, '3758483058', 3, 'Tarjeta Debito', '2017-04-17 17:39:56', 'sin luz en el local disculpe los incovenientes');
...
-- Dumping data for table deliverydb.persona: ~3 rows (approximately)
...
-- Dumping data for table deliverydb.producto: ~11 rows (approximately)
...
INSERT IGNORE INTO `producto` (`prod_id`, `prod_idCategoria`, `prod_nombre`, `prod_codigoProducto`, `prod_descripcionProducto`, `prod_precioBase`, `prod_maxComponente`, `prod_minComponente`, `prod_idEstado`, `prod_idEstadoVisible`, `prod_idSucursal`, `prod_imagen`) VALUES
	(1, 3, 'Napolitana', '01256', 'Muzzarela, salsa ajo y rodajas de tomate', 120, 0, 0, 1, 1, 4, 'pizzacalabresa1.png'),
	...
	(11, 7, 'Pizza Promo', '134', 'Pizza Promo', 0, 0, 0, 2, 2, 4, NULL);
...
-- Dumping data for table deliverydb.productopedido: ~4 rows (approximately)
/*!40000 ALTER TABLE `productopedido` DISABLE KEYS */;
INSERT IGNORE INTO `productopedido` (`pp_id`, `pp_precioBase`, `pp_idProducto`, `pp_precioCalc`, `pp_aclaracion`, `pp_idVariedad`, `pp_nombreVariedad`) VALUES
	(5, 120, 1, 255, 'Sin Aclaracion', 14, ''),
	(6, 98, 2, 216, 'Sin Aclaracion', 2, ''),
	(7, 98, 2, 216, 'Sin Aclaracion', 1, ''),
	(8, 121, 6, 242, 'Sin Aclaracion', 11, '');
...
-- Dumping data for table deliverydb.productopromo: ~7 rows (approximately)
...
-- Dumping structure for table deliverydb.productopromopedido
...
-- Dumping data for table deliverydb.productopromopedido: ~2 rows (approximately)
...
-- Dumping data for table deliverydb.promo: ~5 rows (approximately)
...
INSERT IGNORE INTO `promo` (`pro_id`, `pro_nombre`, `pro_descripcion`, `pro_precio`, `pro_descuento`, `pro_FechaInicio`, `pro_FechaFin`, `pro_imagen`, `pro_idEstado`) VALUES
	(1, 'Promo 1', 'Algo', 150, 20, '1970-01-01', '1970-01-01', 'Combo_7.jpg', 1),
	(2, 'Promo2', 'Algo', 130, 30, '2017-02-23', '2017-02-23', 'promo2.jpg', 1),
	(3, 'Promo3', 'Algo', 140, 40, '2017-02-23', '2017-02-23', 'promo3.jpg', 1),
	(6, 'promo 4', 'ALGO', 150, 20, '2017-01-04', '1970-01-01', NULL, 2),
	(7, 'Combo 5', '1 empanada + 1 gaseosa ', 120, 0, '2017-01-04', '1970-01-01', NULL, 2);
...
-- Dumping data for table deliverydb.sucursal: ~0 rows (approximately)
...
-- Dumping data for table deliverydb.tablasrelacion: ~4 rows (approximately)
...
-- Dumping structure for table deliverydb.telefonocontacto
...
-- Dumping data for table deliverydb.telefonocontacto: ~4 rows (approximately)
...
-- Dumping data for table deliverydb.variedad: ~14 rows (approximately)
...
INSERT IGNORE INTO `variedad` (`var_id`, `var_idProducto`, `var_nombre`, `var_descripcion`, `var_tipo`, `var_precio`) VALUES
	...
	(13, 1, 'Grande', 'Napolitana Grande', 'Tamaño', 150),
	(14, 1, 'Media Grande', 'Media Grande Napolitana', 'Tamaño', 180),
	(17, 11, 'Fugazzeta', 'Pizza Fugazzeta', 'Sabor', 0),
	(18, 11, 'Napolitana', 'Napolitana', 'Sabor', 0);
